...
function render(){
 ...
 <div class="build-next"><div class="hints"><button class="text-button" data-action="hint">需要一點提示？</button>${hints>0?`<p>${hintText()}</p>`:''}</div><button class="primary full" data-action="ready-run">下一步：執行指令 →</button></div>
